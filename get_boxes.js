...
console.log('desk1', readGlb('./public/gbl/desks/desk1.glb'));
console.log('desk2', readGlb('./public/gbl/desks/desk2.glb'));
console.log('desk3', readGlb('./public/gbl/desks/desk3.glb'));
